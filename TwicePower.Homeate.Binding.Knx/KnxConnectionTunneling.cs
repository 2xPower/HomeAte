...
using TwicePower.Homeate.Binding.Knx.Exceptions;
using TwicePower.Homeate.Binding.Knx.Log;
using System;
using TwicePower.Homeate.Binding.Knx.CoreWrapper;
...
namespace TwicePower.Homeate.Binding.Knx
{
    ...
    public class KnxConnectionTunneling : KnxConnection
    {
        ...
        {
            Logger.Info(ClassName, "TwicePower.Homeate.Binding.Knx connecting...");
            ...
            try
            {
                ...
                {
                    Client = { /*DontFragment = true, FAILS ON LINUX*/ SendBufferSize = 0, ReceiveTimeout = stateRequestTimerInterval * 2 }
                };
